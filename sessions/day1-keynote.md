...
最後に Managed Deep Agents は、Deep Agents harness、LangSmith Deployments、Context Hub、Sandboxes、MCP tools、streaming protocol を単一の production 向け API としてまとめる private preview として発表された。
...
- Sandboxes は agent の code execution を production で扱うための基盤として GA。
